	...
	<section id="navigation" class="shadow">
		...
		<div class="inner navigation">
				...
				<div class="logo">
					...
					<?php if ($this->countModules('language_switcher')) : ?>
						<jdoc:include type="modules" name="language_switcher" style="none" />
					<?php endif; ?>
					

<!-- <ul class="nav main-nav2" style="padding-left: 1049px;">
<li class="item-101  active dropdown-toggle nav-toggle">
	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Panamá<b data-toggle="dropdown" class="caret"></b>
	</a><ul class="dropdown-menu">
	<li class="item-107">	
		<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Costa Rica</a></li>
		<li class="item-112">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Guatemala</a></li>
		<li class="item-134">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">El Salvador</a></li>
	</ul>
</li>
	<li class="item-135">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Chat 24/7</a></li>
</ul> -->


<!-- <ul class="nav main-nav2" style="padding-left: 1049px;">
<li class="item-101  active dropdown-toggle nav-toggle"><a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Panamá<b data-toggle="dropdown" class="caret"></b></a><ul class="dropdown-menu"><li class="item-107">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Costa Rica</a></li><li class="item-112">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Guatemala</a></li><li class="item-134">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">El Salvador</a></li></ul></li><li class="item-135">	<a class="scroll" href="/Wisten_main/Quickstart/wisten_j341-final/wisten_j341-final/">Chat 24/7</a></li></ul> -->
	...
	<section id="about" class="contain ">
		...
		<div class="about inner"  style="text-align:center">
...
<!-- 	<?php if ($this->countModules('team_content')) : ?>
	...
	<section id="contact" class="contain ">
			...
			<!-- Google Map -->
			<jdoc:include type="modules" name="contactform_map" style="xhtml" />
...
var script = document.createElement("script");script.async=true;script.type="text/javascript";var src = "http://chat.unityseguros.com/chat/unity_ducruet/server.php?a=b3c2f&rqst=track&output=jcrpt&hg=P3N1cHBvcnQ_&ovlp=MjI_&ovlc=IzAwODBmZg__&ovlct=I2ZmZmZmZg__&ovlt=Q2hhdCBlbiBsw61uZWE_&nse="+Math.random();setTimeout("script.src=src;document.getElementById('livezilla_tracking').appendChild(script)",1);</script><noscript><img src="http://chat.unityseguros.com/chat/unity_ducruet/server.php?a=b3c2f&amp;rqst=track&amp;output=nojcrpt&hg=P3N1cHBvcnQ_&ovlp=MjI_&ovlc=IzAwODBmZg__&ovlct=I2ZmZmZmZg__&ovlt=Q2hhdCBlbiBsw61uZWE_" width="0" height="0" style="visibility:hidden;" alt=""></noscript><!-- http://www.LiveZilla.net Tracking Code -->	
