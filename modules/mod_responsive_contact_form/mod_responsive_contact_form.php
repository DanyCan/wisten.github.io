	  ...
	  <?php $formKey->outputKey(); ?>
		...
		<!-- Name Field -->
		  <div class="control-group">
			<div class="controls">
			  <input class="form" name="name" type="text" id="inputName" placeholder="<?php echo $params->get('ffield_name'); ?>" required>
		 ...
		 <!-- E-mail Field -->
		  ...
		  <div class="control-group">
			<div class="controls">
			  <input class="form" name="email" type="email" id="inputEmail" placeholder="<?php echo $params->get('sfield_name'); ?>" <?php echo $params->get('email_req'); ?>>
			  <p class="help-block"></p>
			</div>
		  </div>
		  <?php }
		  ...
		  <div class="control-group">
			<div class="controls">
			  <input class="form" name="phone" type="text" id="inputPhone" placeholder="<?php echo $params->get('tfield_name'); ?>" <?php echo $params->get('phone_req'); ?>>
			  <p class="help-block"></p>
			</div>
		  </div>
		  <?php
		 ...
		 <!-- Subject Field -->
		  <div class="control-group">
			<div class="controls">
				...
				<select class="form" id="selectSubject" name="type">
				...
				<?php
					...
					{
				?>
						<input class="form" name="type" type="text" id="selectSubject" placeholder="<?php echo $params->get('fofield_name'); ?>" required>
						<p class="help-block"></p>
				<?php
					}
				?>
		 ...
		 <!-- Message Field -->
		  <div class="control-group">
			<div class="controls">
			  <textarea class="form textarea" name="message" id="inputMessage" placeholder="<?php echo $params->get('fifield_name'); ?>" minlength="<?php echo $params->get('msg_minlength'); ?>" required></textarea>
			  <p class="help-block"></p>
			</div>
		  </div>
		  <?php
		 ...
		 <!-- Submit Button -->
		  <div class="control-group">
			<div class="controls">
			  <button type="submit" name="sbutton" value="Send" class="btn form-btn <?php echo $params->get('button_color');?>"><i class="fa fa-envelope"></i> <?php echo $params->get('bs_name');?></button>
			</div>
		  </div>
		  <?php
				}
